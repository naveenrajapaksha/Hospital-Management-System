...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['question_submit'])) {
    ...
    if (!empty($question)) {
        ...
        $sql = "INSERT INTO queries (patient_id, doctor_id, question, answer) VALUES (?, ?, ?, NULL)";
...
<body>
    ...
    <div class="content">
        ...
        <div class="appointment-box">
            ...
            <form action="queries.php" method="POST" class="appointment-form">
                ...
                <br><br>
                <label for="question">🖊️ Ask your Doctor:</label>
