...
<head>
    ...
    <title>Admin | Manage Lab Reports</title>
    <link rel="stylesheet" >
    <style>
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="manage_laprepots.php"><button>Manage Lab reports</button></a>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <form action="update labreports.php" method="POST" style="display:inline;">
